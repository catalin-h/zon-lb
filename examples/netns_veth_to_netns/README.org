...
------------------------------------------------------------
[  1] local 10.0.0.2%veth1 port 38688 connected with 10.0.0.1 port 23 (sock=3) (icwnd/mss/irtt=14/1448/87) (ct=0.15 ms) ...
[ ID] Interval            Transfer    Bandwidth       Write/Err  Rtry     Cwnd/RTT(var)        NetPwr
[  1] 0.0000-10.0154 sec  4.09 GBytes  3.51 Gbits/sec  33522/0        145      147K/976(1462) us  449490
#+end_src
...
as this will slow down the performance significantly.
